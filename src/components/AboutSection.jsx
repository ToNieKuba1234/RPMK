...
export default function AboutMe() {
    ...
    return (
        <div className="w-full h-[650px] flex border-t border-black">
            ...
            <div
                ref={sectionRef}
                className="w-[65%] p-16 bg-slate-200 flex flex-col justify-center"
            >
                <h2
                    className={`text-5xl font-serif mb-8 text-gray-800 transition-transform duration-1000 ease-out ${
                ...
                <p
                    className={`text-lg text-gray-700 transition-transform duration-1000 ease-out ${
                        isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
                    }`}
                >
